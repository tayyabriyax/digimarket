...
import { createAsset, deleteUserAssetById, getAssetById, getAssetsByFilters, getUsersAllAssets } from "../controllers/asset.js";
...
router.route("/get-assets").get(getAssetsByFilters);
